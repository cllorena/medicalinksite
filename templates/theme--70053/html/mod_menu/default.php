...
$justifychk = false;
$navid = '';
$module_style = htmlspecialchars( $params->get( 'module_style' ) );
if ($module_style === 'custom_style') {
$active_color = htmlspecialchars( $params->get( 'active_color' ) );
$hover_color  = htmlspecialchars( $params->get( 'hover_color' ) );
$normal_color = htmlspecialchars( $params->get( 'normal_color' ) );
if (!empty($active_color) || !empty($hover_color) || !empty($normal_color)) {
$navid = 'id="nav_menu-' . $module->id . '" ';
}
}
?>
...
<nav <?php echo $navid;?>class="navbar-default navbar-expand-md navbar nav-menu-default">
...
<nav <?php echo $navid;?>class="navbar">
...
if ($item->deeper) {
if($item->level==$start){
echo '<hr class="horiz_separator" /><ul role="menu"id="dropdown-menu" class="child collapse dropdown-menu menu-dropdown-styles">';
	}
else{
echo '<hr class="separator" /><ul role="menu" class="dropdown-menu sub-menu menu-dropdown-styles" >';
}
